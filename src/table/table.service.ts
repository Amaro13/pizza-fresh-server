...
export class TableService {
  ...
  create(dto: CreateTableDto): Promise<Table> {
    ...
    return this.prisma.table.create({ data }).catch(handleError); // this returns the new data table(since it has the name data you can just write data instead of data:data) to the prisma table with the id getting created automatically with the ORM. If an error occurs it prints the error and returns undefined.
  }
